...
df = pd.read_csv(data_path / "demographics" / "census-2019-alldata5.csv")
...
# %%
nibrs_df = pd.read_csv(data_path / "NIBRS" / "cannabis_2019_20210608.csv", usecols=["dm_offender_race_ethnicity", "dm_offender_age", "dm_offender_sex", "arrest_type","cannabis_mass"])
