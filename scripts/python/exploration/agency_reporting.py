"""This script contains functionality to calculate the proportion (by agencies or population) """
...
def print_coverage(agency_proportion: pd.DataFrame, population_proportion: pd.DataFrame) -> None:
