...
res = stats.linregress(x=sb_df.income_county_ratio, y=sb_df.selection_ratio_log10)

g = sns.jointplot(data=sb_df, x="income_county_ratio", y="selection_ratio_log10", kind="reg")
...
g = sns.jointplot(data=sb_df_temp, x="income_bw_ratio", y="selection_ratio_log10", kind="reg")
...
res = stats.linregress(x=sb_df_temp.income_b_county_ratio, y=sb_df_temp.selection_ratio_log10)

g = sns.jointplot(data=sb_df_temp, x="income_b_county_ratio", y="selection_ratio_log10", kind="reg")
plt.text(x=0.5, y=2.2, s=f"slope: {res.slope:.6f}\n ci: {res.pvalue:.6f}")
